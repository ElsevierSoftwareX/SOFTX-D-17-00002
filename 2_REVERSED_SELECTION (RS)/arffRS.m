function [arffdataRS] = arffRS(ARFFvariable7,ARFFvariable6,ARFFvariable5,ARFFvariable4,ARFFvariable3,ARFFvariable2,ARFFvariable1,~)

%%%%%%%% ARFF 128x128 %%%%%%%%

         name128 = 'Birlesik_IR_RSC128x128';
         ...
         arffdataRS = dataname_128x128arff;
         
%%%%%%%% ARFF 64x64 %%%%%%%%

         name64 = 'Birlesik_IR_RSC64x64';
